# Destruction Derby 2 Recompiled
<!-- retcomm-readme-metrics -->
[![GitHub downloads (all assets, all releases)](https://img.shields.io/github/downloads/Alexbeav/destruction-derby-2-recomp/total)](https://github.com/Alexbeav/destruction-derby-2-recomp/releases)
[![GitHub downloads (latest release)](https://img.shields.io/github/downloads/Alexbeav/destruction-derby-2-recomp/latest/total)](https://github.com/Alexbeav/destruction-derby-2-recomp/releases/latest)
[![GitHub release](https://img.shields.io/github/v/release/Alexbeav/destruction-derby-2-recomp)](https://github.com/Alexbeav/destruction-derby-2-recomp/releases/latest)
<!-- /retcomm-readme-metrics -->

Static recompilation of **Destruction Derby 2** built on
[psxrecomp](https://github.com/Alexbeav/psxrecomp) and
[recomp-ui](https://github.com/mstan/recomp-ui).

A native recompilation setup host for Destruction Derby 2.
...
Zip prefix for CI artifacts: `Destruction-Derby-2-Recomp`.
...
The `v0.3.4` source uses `Destruction_Derby_2_Recompiled` in CMake, the setup relaunch, and the packager.
It accepts the canonical multi-BIN Track 01 identity and the supported merged-BIN compatibility identity.
