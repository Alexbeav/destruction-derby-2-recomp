...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    .display_name = "destruction-derby-2-",
    .project_root_env = "DESTRUCTION_DERBY_2_RECOMP_PROJECT_ROOT",
    .build_dir_env = "DESTRUCTION_DERBY_2_RECOMP_BUILD_DIR",
    .force_setup_env = "DESTRUCTION_DERBY_2_RECOMP_FORCE_SETUP",
    .psxrecomp_cli_relpath = "psxrecomp/psxrecomp_cli.py",
    .seed_cfg_relpath = "game.toml",
    .game_toml_relpath = "game.toml",
    .gen_marker_relpath = "generated/SCUS_943.50_dispatch.c",
    .build_dir_name = "build-release",
    .cmake_target = "psx-runtime",
    .exe_basename = "destruction_derby_2__Recompiled",
    .prepare_note =
